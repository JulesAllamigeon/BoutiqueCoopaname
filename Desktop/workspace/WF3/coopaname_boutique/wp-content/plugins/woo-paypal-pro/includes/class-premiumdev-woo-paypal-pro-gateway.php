        ...
        try {
            ...
            if ($this->send_items) {
                ...
                if (sizeof($order->get_items()) > 0) {
                    ...
                    $this->post_data['ITEMAMT'] = number_format(( $order->get_subtotal() + $order->get_total_shipping() + $this->fee_total ) - $order->get_total_discount(), 2);
                    $this->post_data['TAXAMT'] = number_format($order->get_total_tax(), 2);
                }
            }
